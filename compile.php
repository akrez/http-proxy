...
// use first argument as output file or use "akrezhttpproxy-{version}.php"
$out = isset($argv[1]) ? $argv[1] : ('akrezhttpproxy-' . $version . '.php');
...
system('sed -n "/\#\!/,/^$/p" akrezhttpproxy.php | sed -e "s/version dev/version ' . $version . '/" > ' . escapeshellarg($out));
